            ...
            <div class="container">
                ...
                <div class="row margin-bottom-40">
                    ...
                    <div class="col-md-9 col-sm-7">
                        ...
                        <form  class="form-horizontal form-without-legend" action="MyAccount?cat=confirm" method="POST"  >
                        <div class="content-page">
                            <div class="row form-group">
                                <label class="col-lg-2 control-label" for="first-name">Username</label>
                                <div class="col-lg-6">

                                    <input type="text" name="username" id="username" class="form-control" value="<c:out value="${sessionScope.Client.username}" />" readonly>
                                </div>
                            </div>
                            <div class="row form-group">
