...
//    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String catgenre = request.getParameter("catgenre");
        ...
        if ((catgenre == null) ) {
            ...
            produitListe = ProduitManager.getListeProduitGenre(catgenre);
            request.setAttribute("produits", produitListe);
        }
        RequestDispatcher disp = getServletContext().getRequestDispatcher("/WEB-INF/produitlist.jsp");
